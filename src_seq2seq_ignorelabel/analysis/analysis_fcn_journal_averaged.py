...
def experiments_plot(metrics,experiment_list,dataset):
	...
	ax.legend(tuple(exp_handler), (approach1,approach2,approach3),loc='lower center', bbox_to_anchor=(0.5, -0.29), shadow=True, ncol=3)
	ax2.legend(tuple(exp_handler2), (approach1,approach2,approach3),loc='lower center', bbox_to_anchor=(0.5, -0.29), shadow=True, ncol=3)
	ax3.legend(tuple(exp_handler3), (approach1,approach2,approach3),loc='lower center', bbox_to_anchor=(0.5, -0.29), shadow=True, ncol=3)
